...
(define (play-game)
  (printf "Welcome to Prison Escape! ~n ~n *To play the game, simply write what your want you character to do. ~n *For a list of possible commands, enter help.  ~n
~n Enjoy the game! ~n ~n You find yourself in a dark prison cell. ~n How did you even get here? ~n You must get out! ~n")
  (interaction-loop))